...
public class ResourceLoader : MonoBehaviour {
    ...
    void CreateIngredients() {
        ingredients = new Dictionary<string, Ingredient> {
            ...
            { "lily", new Ingredient(new Ingredient.Attributes[] { Ingredient.Attributes.transformation, Ingredient.Attributes.mana, Ingredient.Attributes.dyeRed }, "lily", "Plants/lily_inv") },
            ...
            { "morel", new Ingredient(new Ingredient.Attributes[] { Ingredient.Attributes.healing, Ingredient.Attributes.endSocial }, "morel", "Plants/morel_inv") },
            { "fly_agaric", new Ingredient(new Ingredient.Attributes[] { Ingredient.Attributes.poison, Ingredient.Attributes.dyeRed, Ingredient.Attributes.endChaos }, "fly_agaric", "Plants/fly_agaric_inv") },
            ...
            { "lapis_lazuli", new Ingredient(new Ingredient.Attributes[] { Ingredient.Attributes.dyeBlue, Ingredient.Attributes.mana }, "lapis_lazuli", "Gems/lapis_inv") },
            { "emerald", new Ingredient(new Ingredient.Attributes[] { Ingredient.Attributes.dyeGreen, Ingredient.Attributes.endOrder }, "emerald", "Gems/emerald_inv") },
            ...
            { "garnet", new Ingredient(new Ingredient.Attributes[] { Ingredient.Attributes.dyeRed }, "garnet", "Gems/garnet_inv") },
            ...
            { "algae", new Ingredient(new Ingredient.Attributes[] { Ingredient.Attributes.dyeGreen, Ingredient.Attributes.poison }, "algae", "Plants/algae_inv") },
            { "snail", new Ingredient(new Ingredient.Attributes[] { Ingredient.Attributes.dyePurple, Ingredient.Attributes.sleep }, "snail", "Other/snail_inv") },
