...
public class ShrineManager : MonoBehaviour {
    ...
    void SetupDialogue() {
        ...
        dialogue.Add("nature", new string[] {"Dear little witch, do you wish to learn?", "A potion that shall give chaos a turn?", "You must combine these ingredients three, if you want the earth to be truly free:",
            ...
            "Finally, a bloom of a plant that you know to have the powers of poison, mana, and transformation inside.", "Brew these together and you will find the power to free the world with a chaotic tide." });
