...
class SteamAchievementManager : MonoBehaviour {
    public enum Achievement : int {
        lets_get_brewing,
        gotta_go_fast,
        i_need_healing,
        the_invisible_man,
        double_bubble_toil_and_trouble,
        sleeping_beauty,
        whimsy,
        dyeing_to_meet_you,
        burn_baby_burn,
        youve_got_a_friend_in_me,
        the_wicked_witch_of_the_cottage,
        his_holy_tentacleness,
        the_deer_hunter,
        the_magic_within,
        mananana
    };
    ...
    public Achievement_t[] m_Achievements = new Achievement_t[] {
        new Achievement_t(Achievement.lets_get_brewing, "Let's get brewing", "Brew a potion"),
        new Achievement_t(Achievement.gotta_go_fast, "Gotta Go Fast", "Brew a speed potion"),
        new Achievement_t(Achievement.i_need_healing, "I need healing!", "Brew a healing potion"),
        new Achievement_t(Achievement.the_invisible_man, "The invisible man", "Brew an invisibility potion"),
        new Achievement_t(Achievement.double_bubble_toil_and_trouble, "Double Bubble Toil and Troubble", "Brew a poison potion"),
        new Achievement_t(Achievement.sleeping_beauty, "Sleeping beauty", "Brew a sleeping potion"),
        new Achievement_t(Achievement.whimsy, "Whimsy!", "Brew a transformation potion"),
        new Achievement_t(Achievement.dyeing_to_meet_you, "Dye-ing to meet you", "Brew a dye potion"),
        new Achievement_t(Achievement.burn_baby_burn, "Burn baby burn", "Aquire the ash ingredient"),
        new Achievement_t(Achievement.youve_got_a_friend_in_me, "You've got a friend in me", "Have a positive relationship with everyone"),
        new Achievement_t(Achievement.the_wicked_witch_of_the_cottage, "Wicked Witch of the Cottage", "Have a negative relationship with everyone"),
        new Achievement_t(Achievement.his_holy_tentacleness, "His holy tentacleness", "Have a positive relationship with the Priest of Order"),
        new Achievement_t(Achievement.the_deer_hunter, "The Deer Hunter", "Have a positive relationship with the nature spirit"),
        new Achievement_t(Achievement.the_magic_within, "The Magic Within", "Have a positive relationship with the spirit of the village"),
        new Achievement_t(Achievement.mananana, "Mananana", "Brew a mana potion")
    };
    ...
    private void Update() {
        ...
        /* TODO: Handle when event happens rather than here
    ...
    /*TODO: Don't think I need this either
    //-----------------------------------------------------------------------------
